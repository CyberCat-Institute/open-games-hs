...
#define CURRENT_PACKAGE_KEY "open-games-hs-engine-0.1.0.0-DGwEsvyDBvRAKuOkBETU7e"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "open-games-hs-engine-0.1.0.0-DGwEsvyDBvRAKuOkBETU7e"
